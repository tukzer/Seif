using Seif.Core.Configuration;
using Seif.Core.Data;
using Seif.Core.Timing;
using System;
...
namespace Seif.Core
{
    public static class ApplicationContext
    {
        ...
        {
            // Initialize defaults.
            SetDefault<IClockProvider>(new LocalClockProvider());
        ...
        public static T Get<T>() where T : class
        {
            ...
            Logger.DebugFormat("Requesting instance {0} from the environment.", typeof(T).FullName);
            ...
            if(result == null)
                throw new EnvironmentConfigurationException(typeof(T));
        ...
        public static void Configure(IEnvironmentConfiguration source)
        {
            ...
            Logger.InfoFormat("Environment configured with {0} configuration source.", source.GetType().FullName);
        }
